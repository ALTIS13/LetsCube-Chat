...
23. `[~]` Owner decisions from the 2026-09-11 wave.
   ...
   - `[ ]` D-063 (the registration confirmation card on a narrow screen) and D-071 (the message hover actions at tablet width): rendered options sent to the owner on 2026-09-11, decision pending.
