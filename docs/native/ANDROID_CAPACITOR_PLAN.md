...
- Media picker/upload/quality/original/playback, camera/photo/regular video/
  video-circle/voice, no-unread bottom anchoring, fast-upward scrolling, prepend
  anchoring, message-footer stability and an explicit logout/login cycle remain
  mandatory physical QA gates. Task 4 remains open.
