...
export const PERMISSION_DESCRIPTION: Record<string, string> = {
  ...
  "users.assign_roles": "Назначать глобальные роли и роли в локациях пользователям.",
  "locations.view": "Видеть доступные локации и назначения.",
  "locations.manage": "Создавать и редактировать локации.",
  "location_members.view": "Видеть сотрудников и администраторов локаций.",
  ...
  "tasks.manage_all_locations": "Управлять задачами всех локаций.",
