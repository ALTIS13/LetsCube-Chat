      ...
      <div>
        ...
        {durationKey === "custom" && (
          <input
            ...
            className="mt-2 w-full rounded-xl px-3 py-2 text-sm outline-none bg-[var(--kub-surface-2)] text-[color:var(--kub-text)] border border-[color:var(--kub-border-color)] focus:border-[color:var(--kub-cyan)] transition-all"
          />
        )}
      </div>
