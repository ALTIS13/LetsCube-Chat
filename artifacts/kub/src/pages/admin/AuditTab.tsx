            ...
            {actorPicked ? (
              <div className="flex items-center gap-2 rounded-xl px-3 h-11 bg-[var(--kub-inset)] border border-[color:var(--kub-cyan)]/40">
                ...
                <button
                  ...
                  className="p-1 rounded kub-raise-hover text-[color:var(--kub-muted)]"
                  aria-label="Сбросить"
                >
              ...
              <div className="kub-glass-strong absolute z-10 left-0 right-0 mt-1 rounded-xl py-1 max-h-72 overflow-y-auto border border-[color:var(--kub-border-color)]">
                {actorOptions.map((p) => (
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2 kub-raise-hover text-left"
                  >
...
function diffLabel(key: string): string {
  const labels: Record<string, string> = {
    ...
    location_id: "Локация",
    location_role_id: "Роль в локации",
    mute_id: "Мьют",
