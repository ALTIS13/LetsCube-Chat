                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <label className="min-w-0 text-xs font-medium text-[color:var(--kub-muted)]">
                    ...
                    <input
                      ...
                      className="h-10 w-full rounded-xl border border-[color:var(--kub-border-color)] bg-[var(--kub-inset)] px-3 text-sm text-[color:var(--kub-text)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--kub-cyan)]"
                    />
                  </label>
                </div>
