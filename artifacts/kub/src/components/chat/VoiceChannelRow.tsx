 ...
 *
 * **It draws one room and never offers to make or remove one.** Until
 * 2026-09-14 it also carried «Начать голосовой чат» and «Завершить голосовой
 * чат», and those were the one-room mechanic: a group had a voice chat or it
 * did not. A group has rooms now, made and removed in «Каналы» on the settings
 * screen, and a second creator here would be two ways to make a thing that
 * differ in what they can make. The room it draws is `capsuleChannel` from
 * `ChatWindow`, which is null as soon as there is a choice between rooms —
 * naming whichever came first is not a fact about the group.
 */
