      ...
      <div className="flex-1 min-w-0 flex flex-col gap-0.5" data-chat-row-body="">
        <div className="flex min-w-0 items-center justify-between gap-2">
          <div className="flex items-center gap-1 min-w-0">
            ...
            <span className="kub-ios-chat-list-title text-sm font-semibold truncate text-[color:var(--kub-text)]">
              {display.title}
            </span>
        ...
        <div className="flex min-w-0 items-center justify-between gap-2">
          <span className="kub-ios-chat-list-preview block min-w-0 flex-1 truncate text-left text-xs leading-4 text-[color:var(--kub-muted)]">
