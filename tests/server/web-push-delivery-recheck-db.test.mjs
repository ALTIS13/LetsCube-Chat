...
test("a claimed Web Push row is rechecked against read, foreground and subscription state", async () => {
  ...
  try {
    await db.exec(`
      ...
      insert into public.push_subscriptions(id,is_active) values
        ...
        ('30000000-0000-4000-8000-000000000004',false),
        ('30000000-0000-4000-8000-000000000005',true),
        ('30000000-0000-4000-8000-000000000006',true);
